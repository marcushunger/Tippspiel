...
public class NoteeintragenForm {
	...
	private List<Usermodul> listeusermodule;
	
	public NoteeintragenForm(HttpServletRequest request, List<Usermodul> listeUsermodule){
		...
		listeusermodule = listeUsermodule;
	}
...
//	}
	...
	public List<Usermodul> getListeusermodule() {
		return listeusermodule;
	}


	public void setListeusermodule(List<Usermodul> listeusermodule) {
